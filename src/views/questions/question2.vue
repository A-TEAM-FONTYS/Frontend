...
<div class="bg-outer-space h-max w-max p-6 text-pampas">
    <div>
      ...
      <div class="mt-10 text-center text-pampas">
            <div class="inline-block align-bottom">
                <p class="text-s font-serif font-light mt-5">At what age did you start using the app?</p>
            </div>
        </div>
        <v-numberInput></v-numberInput>
        <div class="mt-10 text-center text-pampas">
            <div class="inline-block align-bottom">
                <p class="text-s font-serif font-light mt-5">How many times a day are you using the app?</p>
            </div>
        </div>
        <v-numberInput></v-numberInput>
        <div class="mt-10 text-center text-pampas">
